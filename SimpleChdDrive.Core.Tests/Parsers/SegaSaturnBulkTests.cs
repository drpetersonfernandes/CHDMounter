...
public class SegaSaturnBulkTests
{
    ...
    public SegaSaturnBulkTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    public void ParseEntireMameSaturnLibrary()
    {
        ...
        _output.WriteLine($"Found {chdFiles.Count} CHD files (MAME saturn)");
    ...
    public void ParseEntireISegaSaturnLibrary()
    {
        ...
        _output.WriteLine($"Found {chdFiles.Count} CHD files (I: Sega Saturn)");
        Assert.NotEmpty(chdFiles);
    ...
    [Fact]
    public void ParseAllSaturnLibraries()
    {
        ...
        foreach (var libPath in LibraryPaths)
        {
            ...
            var searchOpt = libPath.Contains("saturn", StringComparison.OrdinalIgnoreCase)
