...
public class NeoGeoCdBulkTests
{
    ...
    public NeoGeoCdBulkTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    public void ParseEntireMameNeocdLibrary()
    {
        ...
        _output.WriteLine($"Found {chdFiles.Count} CHD files (MAME neocd)");
    ...
    public void ParseEntireJNeoGeoCdLibrary()
    {
        ...
        _output.WriteLine($"Found {chdFiles.Count} CHD files (J: SNK Neo Geo CD)");
        Assert.NotEmpty(chdFiles);
    ...
    [Fact]
    public void ParseAllNeoGeoCdLibraries()
    {
        ...
        foreach (var libPath in LibraryPaths)
        {
            ...
            var searchOpt = libPath.Contains("neocd", StringComparison.OrdinalIgnoreCase)
