...
public class PspParser : Iso9660Wrapper
{
    ...
    public override ConsoleType GetConsoleType() => ConsoleType.PSP;
    public override string GetConsoleName() => "PSP";
}

public class PcEngineCDParser : Iso9660Wrapper
{
    public PcEngineCDParser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.PcEngineCD;
    public override string GetConsoleName() => "PC Engine CD";
}

public class PcFxParser : Iso9660Wrapper
{
    public PcFxParser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.PcFx;
    public override string GetConsoleName() => "PC-FX";
}

public class SegaGenesisCDParser : Iso9660Wrapper
{
    public SegaGenesisCDParser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.SegaGenesisCD;
    public override string GetConsoleName() => "Sega Genesis CD";
}

public class SegaSaturnParser : Iso9660Wrapper
{
    public SegaSaturnParser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.Saturn;
    public override string GetConsoleName() => "Saturn";
}

public class NeoGeoCDParser : Iso9660Wrapper
{
    public NeoGeoCDParser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.NeoGeoCD;
    public override string GetConsoleName() => "NeoGeo CD";
}

public class AmigaCD32Parser : Iso9660Wrapper
{
    public AmigaCD32Parser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.AmigaCD32;
    public override string GetConsoleName() => "Amiga CD32";
}

public class AmigaCDParser : Iso9660Wrapper
{
    public AmigaCDParser(SectorReader reader) : base(reader) { }
    public override ConsoleType GetConsoleType() => ConsoleType.AmigaCD;
    public override string GetConsoleName() => "Amiga CD";
}
...
public abstract class Iso9660Wrapper : IConsoleParser
{
    ...
    protected Iso9660Wrapper(SectorReader reader) => _reader = reader;
